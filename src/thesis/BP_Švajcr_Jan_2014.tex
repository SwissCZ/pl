...
\subsubsection{Třída AxiomChecker}
...
\subsubsection{Třída DefaultTarget}

Tato třída představuje stav spuštění aplikace bez explicitního cíle.

\paragraph{executeTarget}

Přijatá vstupní formule je vypsána na výstupu pomocí metody \texttt{printFormula} a~následně je uvolněna z~paměti.

\subsubsection{Třída ProofHandler}
