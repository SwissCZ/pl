...
\begin{exm}
Například věta \uv{Dnes je hezký den} je výrok. Je na čtenáři, aby rozhodl o pravdivosti tohoto výroku. Jiný čtenář by mohl případně rozhodnout opačně.
\end{exm}
...
\verbatiminput{../test/infix\_valid.txt}
